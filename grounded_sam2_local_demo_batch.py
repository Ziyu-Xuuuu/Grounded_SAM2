...
#TEXT_PROMPT = "green-water. left and right wall. ceiling. floating white ball."
TEXT_PROMPT = "grassyshoreline. treetrunks-abovewater. floating-vegetation. open-watersurface."
...
OUTPUT_DIR = Path("outputs/grounded_sam2_local_demo_mhl")
...
def process_image(img_path):
    ...
    fixed_class_id_mapping = {
        "green - water": 0,
        "left and right wall": 1,
        "ceiling": 2,
        "floating white ball": 3,
    }
